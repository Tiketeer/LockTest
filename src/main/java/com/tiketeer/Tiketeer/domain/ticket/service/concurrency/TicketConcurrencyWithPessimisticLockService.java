...
public class TicketConcurrencyWithPessimisticLockService implements TicketConcurrencyService {
	private final TicketRepository ticketRepository;
	private final PurchaseCrudService purchaseCrudService;

	public TicketConcurrencyWithPessimisticLockService(TicketRepository ticketRepository,
